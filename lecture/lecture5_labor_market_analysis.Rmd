...
.footnote[Source: ACS 2013-2017, table = S2301]
...
.footnote[Source: ACS 2013-2017, table = S2408]
...
Potentially very powerful but *VERY* out of data (2010 latest tabulations) and can reproduce most of it with ACS microdata
...
The PUMS (Public Use Microdata Sample) give sus the *individual* survey responses to the ACS
...
PUMS comes in census region, division, state and PUMA only (from census)
  - IPUMS does prive MSA and county estimates, but note the geographies may not be consistent
