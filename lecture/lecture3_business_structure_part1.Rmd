---
title: "USP 597- Regional Business\n Structure"
author: "Jamaal Green"
date: "April 8, 2019"
...
p_load(readr, data.table, janitor, here, kableExtra)
...
## Some Industrial Measures...Locatoin Quotient

A measure of **relative** concentration. Industries with higher location quotients can be a signal of competitive advantage.

$$ \frac{EMP_{it}/\Sigma{EMP_{it}}}{EMP_{ir}/\Sigma{EMP_{ir}}}$$
Where we take the ratio of employment in industry **i** in our region **t** , divided the total employment of region **t** and then divide quotient by the employment in industry **i** in our reference region **r** (often the nation)
