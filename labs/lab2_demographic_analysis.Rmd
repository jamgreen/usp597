...
var_tables <- load_variables(year = 2016, dataset = "acs5", cache = TRUE)

sex_by_age <- get_acs(geography = "metropolitan statistical area/micropolitan statistical area",
                      table = "B01001", year = 2016,survey = "acs5" ,state = "md")
...
```{r pyramid_plot, fig.cap="Demographic Structure, Baltimore MSA, 2016"}
...
ggplot(sex_by_age2, aes(x = age, y = percent, fill = sex)) +
  ...
  labs(x = "", y = "", fill = "", 
    ...
    2012-2016 using tidycensus")

```

Alright...that was a good bit of work, but we've now got a population pyramid for our MSA in 2016.
